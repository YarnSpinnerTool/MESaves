...
namespace Yarn.Unity.MEImporter
{
    ...
    public sealed class HashtagAwareOptionPresenter : DialoguePresenterBase
    {
        [SerializeField] CanvasGroup? canvasGroup;

        [MustNotBeNull]
        [SerializeField] HashtagAwareOptionItem? optionViewPrefab;

        // A cached pool of OptionView objects so that we can reuse them
        List<HashtagAwareOptionItem> optionViews = new List<HashtagAwareOptionItem>();
        ...
        private HashtagAwareOptionItem CreateNewOptionView()
        {
